...
module.exports.spawn = function(config, callback) {
    ...
    Fetcher.prototype.follow = function(callback, callbackEnteredFollowingMode) {
        var self = this;
        assert(_.isFunction(callback));
        ...
        restler.get(server_pending_path, {
            ...
            if (_.isFunction(callbackEnteredFollowingMode)) {
                callbackEnteredFollowingMode();
            }
    ...
    callback({
        ...
        follow: function(callback, callbackEnteredFollowingMode) {
            fetcher.follow(callback, callbackEnteredFollowingMode);
        },
