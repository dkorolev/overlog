...
var spec = {
    ...
    since_ms_then_follow: {
        description: 'Follow the log, like "tail -f", but dump the entries starting from this ms timestamp first.' 
    },
    last_ms_then_follow: {
        description: 'Follow the log, like "tail -f", but dump the entries from the past this number of ms first.' 
    },
    ...
    // TODO(dkorolev): Keepalives as well.
