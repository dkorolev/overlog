...
var spec = {
    ...
    pubsub_port: {
        name: 'Port for PubSub HTTP server.',
        value: 3506,
    },
    pubsub_mount: {
        name: 'PubSub mount point.',
        value: '/pubsub',
    },
    pubsub_channel: {
        name: 'PubSub channel name. When in PubSub mode, lock file is not used in favor of an HTTP socket.',
    },
    storer_pubsub_server_teardown_delay_ms: {
        name: 'Time, in milliseconds, after which the server should be terminated forcefully if a graceful shutdown did not work.',
        value: 2000,
    },
    ...
    fetcher_max_open_files: {
        name: 'Maximum number of open files a fetcher should be attempting to read simultaneously.',
        value: 250
    },
    fetcher_debug: {
        name: 'Allow debugging commands. Also used by the test.',
